...
class AmountRangeRule implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'amountRangeRule';
    ...
    public function setMinAmount($min_amount)
    {
        if (is_null($min_amount)) {
            throw new SanitizedInvalidArgumentException('non-nullable min_amount cannot be null');
        }
    ...
    public function setMaxAmount($max_amount)
    {
        if (is_null($max_amount)) {
            throw new SanitizedInvalidArgumentException('non-nullable max_amount cannot be null');
        }
