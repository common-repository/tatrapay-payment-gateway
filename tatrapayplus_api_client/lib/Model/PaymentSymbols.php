...
class PaymentSymbols implements ModelInterface, \ArrayAccess
{
    ...
    public function setVariableSymbol($variable_symbol)
    {
        ...
        if (!preg_match('/^[0-9]{1,10}$/', ObjectSerializer::toString($variable_symbol))) {
            throw new SanitizedInvalidArgumentException('invalid value for $variable_symbol when calling PaymentSymbols., must conform to the pattern /^[0-9]{1,10}$/.');
        }
    ...
    public function setSpecificSymbol($specific_symbol)
    {
        ...
        if (!preg_match('/^[0-9]{1,10}$/', ObjectSerializer::toString($specific_symbol))) {
            throw new SanitizedInvalidArgumentException('invalid value for $specific_symbol when calling PaymentSymbols., must conform to the pattern /^[0-9]{1,10}$/.');
        }
    ...
    public function setConstantSymbol($constant_symbol)
    {
        ...
        if (!preg_match('/^[0-9]{1,4}$/', ObjectSerializer::toString($constant_symbol))) {
            throw new SanitizedInvalidArgumentException('invalid value for $constant_symbol when calling PaymentSymbols., must conform to the pattern /^[0-9]{1,4}$/.');
        }
